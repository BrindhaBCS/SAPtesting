...
SALES_SAP_SERVER = "$SALES_SAP_SERVER"
SALES_SAP_connection = "$SALES_SAP_connection"
...
sloc= "$sloc"
order_number= "$Copilot_Status_ordernumber"
outbound_delivery_number= "$Copilot_Status_outbounddelivery"
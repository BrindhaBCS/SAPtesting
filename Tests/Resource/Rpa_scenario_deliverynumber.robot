...
Vehicle_number_plate
    ...
    Input Text    element_id=wnd[1]/usr/tabsG_SELONETABSTRIP/tabpTAB004/ssubSUBSCR_PRESEL:SAPLSDH4:0220/sub:SAPLSDH4:0220/ctxtG_SELFLD_TAB-LOW[1,24]    text=21.02.2025

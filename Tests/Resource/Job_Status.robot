...
Display Job Status    
    ...
    Select Checkbox    wnd[0]/usr/chkBTCH2170-READY        
    ...
    ELSE
        ...
        Input Text  wnd[1]/usr/ctxtDY_PATH      ${symvar('job_status_filepath')}
        Input Text  wnd[1]/usr/ctxtDY_FILENAME    ${symvar('job_status_filename')}
        Click Element   wnd[1]/tbar[0]/btn[0]
    END

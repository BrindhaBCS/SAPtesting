...
Rental Document
    ...
    ELSE     
        ...
        Delete Specific File    C:\\TEMP\\rental.xlsx
        Input Text    wnd[1]/usr/ctxtDY_FILENAME    ${EMPTY}
        Input Text    wnd[1]/usr/ctxtDY_FILENAME    rental.xlsx
        Input Text      wnd[1]/usr/ctxtDY_PATH      ${EMPTY}
        Input Text      wnd[1]/usr/ctxtDY_PATH      ${download_path}
        Click Element   wnd[1]/tbar[0]/btn[0]
        Process Excel    C:\\TEMP\\rental.xlsx    Sheet1
        Sleep    2
        Number To String    C:\\TEMP\\rental.xlsx    C
        Sleep    2

...
Get roles from Table
    ...
    Click Element    wnd[1]/tbar[0]/btn[11]
    Sleep    1
    ${role_length}    Roles Extract    file_location=C:\\tmp\\Create_Tcode_extract.xlsx    sheet_name=Sheet1
    ...
    Set Global Variable    ${GLOBAL_TCODE_LENGTH}    ${tcode_length}            # global variable

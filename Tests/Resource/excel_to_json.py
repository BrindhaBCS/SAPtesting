...
# Example usage
excel_file = r'C:\EID_Parry\Rental.xlsx'  
json_file = r'C:\EID_Parry\Rental.json' 

# excel_file = r'C:\EID_Parry\Rental_output.xlsx'  
# json_file = r'C:\EID_Parry\Rental_output.json'

...
FOR ST/BNWVS 
    ...
    Sleep   1
    Select Radio Button    wnd[1]/usr/tabsSTART_OPTIONS/tabpSTART_FC1/ssubSTART_OPTIONS_SCA:SAPLOCS_UI:0701/radLAY0700-RB1_DIA
    Sleep   1
    ...
    Sleep    5 
    Take Screenshot    15_saint11.jpg
...
Process Until Finish Button Visible
    ...
    Log    ${cell_text_2}
    CustomSapGuiLibrary.Take Screenshot    16_saint12.jpg
    Sleep    2

    #Click DoNOTSEND
    Click Element    wnd[1]/tbar[0]/btn[27]
    Take Screenshot    17_saint13.jpg    

System Logout
    Run Transaction   /nex
    Sleep    5
    Take Screenshot    18_logoutpage.jpg    

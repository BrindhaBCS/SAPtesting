...
Trace_status
    ...
    IF    '${trace_status}' == 'Authorization trace is switched on'
        ...
        Sleep    1
        Log To Console    **gbStart**copilot_status**splitKeyValue**Sucessfully Authorization trace is deactivated..**gbEnd**
